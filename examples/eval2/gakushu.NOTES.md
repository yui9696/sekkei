...
- Total effort: **44 person-days**; critical path **29 days**; with a team of 4: **about 32 working days** (7 weeks).
...
|---|---|---|---|---|---|
| Course | — | — | unpublished; transitions not stated | — | R-1 |
| Grade | — | — | — | retention: grade | R-3 |
| Video | — | — | resumed; transitions not stated | — | R-2 |
| Progress | — | — | — | — | R-4 |
