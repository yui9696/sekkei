...
PATTERNS: list[Pattern] = [
    ...
    Pattern("event_ingest", "Event ingestion", [(r"\bpublish(?:es|ed|ing)? (?:an? )?events?\b", 3), (r"\bpublish", 1), (r"\bevents?\b", 1), (r"\bproducer|internal services?\b", 1), (r"\bingest", 2), (r"\bemit", 1)],
